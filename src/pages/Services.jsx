        ...
        >
          <div className="max-w-container-max mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[minmax(250px,auto)]">
              <div className="md:col-span-8 glass-layer rounded-xl p-8 flex flex-col justify-between group relative overflow-hidden service-card hover:-translate-y-1 transition-transform duration-300">
              ...
              <div className="md:col-span-4 bg-primary text-white rounded-xl shadow-[0_8px_32px_0_rgba(0,109,119,0.2)] p-8 flex flex-col justify-between group service-card hover:-translate-y-1 transition-transform duration-300">
                <div>
              ...
              <div className="md:col-span-4 glass-layer rounded-xl p-8 flex flex-col justify-between group service-card hover:-translate-y-1 transition-transform duration-300">
                <div>
                  <span className="material-symbols-outlined text-primary text-[40px] mb-6 service-icon">
                    child_care
                  </span>
              ...
              <div className="md:col-span-8 glass-layer rounded-xl p-8 flex flex-col md:flex-row gap-8 items-center group relative overflow-hidden service-card hover:-translate-y-1 transition-transform duration-300">
